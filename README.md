...
| `.github/workflows/reusable-ci-solidity.yml`        | Foundry CI for Solidity smart contracts. Jobs: `forge fmt`, `forge build`, `forge test`, `forge coverage` (enforces ≥60% line coverage). Per NA-03 §6.1 and §10.4. | ✅   |
